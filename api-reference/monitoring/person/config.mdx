---
title: "Configuração"
keywords: ["configuração monitoramento pf", "fontes monitoramento", "cpf", "lazy data"]
description: "Consulte fontes, preços e frequências disponíveis para monitoramento de pessoa física."
sidebarTitle: "Configuração"
api: "GET /v1/monitoring/person/config"
...
Use `result.monitoring.frequencies[].id` em cada item de `sources` na rota [Criar monitoramento](/api-reference/monitoring/person/create).