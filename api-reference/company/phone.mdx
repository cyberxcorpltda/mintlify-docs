...
description: "Busque pessoas jurídicas vinculadas a um telefone com DDD."
sidebarTitle: "Busca por telefone"
api: "POST /v1/search/company/phone"
...
<ParamField body="phone" type="string" required placeholder="1133334444">
